import { type ActivityStructureId } from "../types";

export const activitiesMockId: ActivityStructureId[] = [
  {
  ...
  {
    _id: "656493fa44b5521c2584c217",
    activityType: "Classes",
    activityName: "Unplugged smoothies bike",
    ledBy: "Caravelle bar",
    date: "13:30",
    startTime: "27/12/2023",
    activityDescription:
